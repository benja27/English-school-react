...
const chapterExamples = [
  ...
  [
    '(en el teléfono) Me alegra que hayas llamado. He estado pensando en llamarte...',
  ...
  [
    'Debbie es una muy buena jugadora de tenis. Ha estado jugando desde los ocho años.',
...
const chapterSolution2 = [
  [
    'Te encuentras con Paul mientras él sale de la piscina. Preguntas: ¿Has estado nadando?',
    'You meet Paul as he is leaving the swimming pool. You ask: Have you been swimming?',
  ],
  ...
  [
    'Un amigo tuyo ahora trabaja en un gimnasio. Quieres saber cuánto tiempo lleva. Preguntas: Cuanto timepo has estado trabajando ahi',
